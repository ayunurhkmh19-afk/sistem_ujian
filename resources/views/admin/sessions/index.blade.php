                    ...
                    <tr class="hover:bg-white/30 transition-colors group">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex justify-center items-center gap-2">
                                <a href="{{ route('sessions.supervisors.index', $session->id) }}" class="p-2 rounded-xl bg-white/40 text-emerald-600 hover:bg-emerald-500 hover:text-white border border-white/50 transition-all shadow-sm" title="Kelola Pengawas">
